...
// LaunchReady should be false. The program, however, is not behaving as expected. the fuelLevel if/else statement printed properly, but the second one had some confusing results.
